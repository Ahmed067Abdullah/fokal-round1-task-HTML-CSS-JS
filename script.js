...
function showErrorBox(field) {
    document.querySelector(`.${field}-error-text`).classList.remove('hidden');
    document.querySelector(`.${field}-error-container`).classList.add('focused-container');
}

function hideErrorBox(field) {
    document.querySelector(`.${field}-error-text`).classList.add('hidden');
    document.querySelector(`.${field}-error-container`).classList.remove('focused-container');
}
